...
if __name__ == '__main__':  
    ...
    # df.to_csv('C:/Users/Sherwin/Desktop/feat_importance_t01.csv', index=False)
  
    plt.figure()  
    df.plot(kind='barh', x='feature', y='fscore', legend=False, fontsize=40,figsize=(46, 30))
    plt.title('XGBoost Feature Importance', fontsize=40)
    plt.xlabel('relative importance', fontsize=40)
    plt.ylabel('feature', fontsize=40)
    plt.savefig('C:/Users/Sherwin/Desktop/test.png')
    plt.show()
