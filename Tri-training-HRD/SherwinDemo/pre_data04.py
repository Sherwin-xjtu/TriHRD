...
data_vcf = "/mnt/GenePlus001/prod/workspace/IFA20180710002/OncoH/output/180003461BCD/variation/hereditary_snv_indel/180003461BCD.vcf"
gvcf1 = "/mnt/X500/farmers/wangxw/newResults/gatk_bundle/1000G_phase1.indels.b37.vcf.gz"
gvcf2 = "/mnt/X500/farmers/wangxw/newResults/gatk_bundle/dbsnp_138.b37.del100.vcf.gz"
gvcf3 = "/mnt/X500/farmers/wangxw/newResults/gatk_bundle/Mills_and_1000G_gold_standard.indels.b37.vcf.gz"
...
def labeled_datas(record,vcf_in,ulable):
...
for record in vcf_in_raw.fetch():
    ...
    labeled_datas(record,vcf_in1,ulable)
    if ulable:
        labeled_datas(record, vcf_in2,ulable)
...
dataframe_U.to_csv("/mnt/X500/farmers/wangxw/tri_training_results/resoult_csv/Test_U__072302.csv",index=False,sep=',')
...
#将DataFrame存储为csv,index表示是否显示行名，default=True
dataframe_L.to_csv("/mnt/X500/farmers/wangxw/tri_training_results/resoult_csv/Test_L__072302.csv",index=False,sep=',')
