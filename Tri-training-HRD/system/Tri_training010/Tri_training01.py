...
from system.Tri_training010.process import Process

from system.Tri_training010.Learn import Learn
from SherwinDemo.Test.RWCSV import RWCSV
import pandas as pd
import math
from system.Tri_training010.bootstrapSample import Sample

from system.Tri_training010.Report import estimate
from system.Tri_training010.Bagging import Bagging
...
class Tri_training01:
    ...
    def pre_data(self):
        ...
        data = 'C:/Users/Sherwin/Desktop/LOH_HRD/lable_result01/train/train.tsv'
        u_data = 'C:/Users/Sherwin/Desktop/LOH_HRD/lable_result02/test_/test.tsv'
        ...
        X_train, X_validation, y_train, y_validation = train_test_split(xt, yt, test_size=0.3,random_state=8,stratify=yt)
        # learn = Learn()
        # self.Learn = learn
        # for i in range(3):
        # 	clf = learn.reModel(i)
    ...
    def Training(self):
        ...
        y_pred = tri_clt.predict(self.UU)
        y_predpro = tri_clt.predict_proba(self.UU)
        self.UU['PreType'] = y_pred
        self.UU['y_predpro'] = y_predpro
        self.UU.to_csv('C:/Users/Sherwin/Desktop/LOH_HRD/lable_result02/test_/result.csv', index=False)
        return self.M
